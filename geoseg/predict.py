...
def parse_args():
    ...
    parser.add_argument("--weight-path", type=str, default=r"C:\Users\1\Desktop\遥感地物提取\test data 2024\ Work_dirs\features_unet_1\best_model.pth", help="weights path")
    parser.add_argument("--img-path", type=str, default=r"C:\Users\1\Desktop\遥感地物提取\test data 2024\trains\images", help="需要预测的图片所在文件夹")
    parser.add_argument("--out-path", type=str, default=r"C:\Users\1\Desktop\遥感地物提取\test data 2024\trains\pred", help="预测结果保留的文件夹")
    parser.add_argument("--lab-path", type=str, default=r"C:\Users\1\Desktop\遥感地物提取\test data 2024\trains\labels", help="预测图片对应的标签所在文件夹")
